...
class AnalysisEngine {
  ...
  static suggestProjects(text: string) {
    ...
    const projectBank: { title: string; description: string; techStack: string[]; difficulty: string; matchKeywords: string[] }[] = [
      ...
      { title: "E-commerce Platform", description: "Build a complete online store with payments, cart, and admin dashboard", techStack: ["Next.js",  "PostgreSQL", "Tailwind"], difficulty: "Advanced", matchKeywords: ["react", "next.js", "javascript", "typescript", "sql"] },
