      ...
      <section className="relative overflow-hidden px-3 pb-10 pt-36 sm:px-4 md:px-6 lg:px-8 lg:pt-44">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <motion.p variants={fadeUp} initial="hidden" animate="show" custom={2}
            ...
            generate tailored cover letters — get started for free.
          </motion.p>
        ...
        <div className="mx-auto max-w-6xl">
          <motion.div variants={fadeUp} custom={0} className="mb-14 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-300">
              Our AI analyses every facet of your resume — from ATS keywords to career growth — so you stand out.
            </p>
          </motion.div>
      ...
      <Section className="px-3 py-24 sm:px-4 md:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {[
              { name: "Sarah Chen", role: "Software Engineer @ Google", text: "This tool helped me  improve my ATS score and identify exactly where my resume needed  improvement.",avatar: "SC" },
              { name: "Ahmed Khan", role: "Data Scientist @ Meta", text: "The skill gap analysis was a game-changer. I walked into my panel round fully prepared.", avatar: "AK" },
      ...
      <Section className="relative overflow-hidden px-3 py-24 sm:px-4 md:px-6 lg:px-8">
        ...
        <motion.div variants={fadeUp} custom={0} className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mb-10 text-lg text-gray-300">
            Join thousands of professionals who optimized their resumes with AI and improved their chances of landing the right opportunities.
            </p>
            <Link to="/register">
